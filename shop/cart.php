<?php
    ...
    $catergory = $_GET["a"];
    $product = $_GET["b"];
    mysqli_query($con,"insert into cart(name,price) select name,price from $catergory where name='$product'");
    ...
    while($row = mysqli_fetch_array($sql)){
        ...
        <tr>
            <th></th>
            <th><?php echo $summ;?></th>
            <th><button class="btn btn-success" onclick="clearcart()">Checkout</button>
        </tr>
